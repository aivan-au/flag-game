...
const packs = {
  starter: {
    name: "Starter Pack",
    codes: ["us", "gb", "fr", "de", "it", "es", "ca", "br", "ru", "ua", "kz", "jp", "cn", "kr", "in", "au", "nz", "za", "fi", "tr"]
  },
  europe: {
    name: "Europe Starter",
    codes: ["de", "gb", "fr", "it", "ru", "es", "tr", "nl", "pl", "ch", "be", "ie", "se", "at", "no", "dk", "ro", "cz", "pt", "fi"]
  },
  southAmerica: {
    name: "South America",
  ...
  largest: {
    name: "Largest",
    codes: ["ru", "ca", "cn", "us", "br", "au", "in", "ar", "kz", "dz", "cd", "dk", "sa", "mx", "id", "sd", "ly", "ir", "mn", "pe"]
  },
  richest: {
    name: "Richest",
